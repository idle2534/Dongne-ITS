...
public class ProjectController {
    ...
    public ResponseEntity<ProjectResponseDto> delete(@RequestBody ProjectMemberRemoveRequestDto request, @RequestParam Long projectId) {
        Project project = projectCommandService.memberRemove(request, projectId);
    ...
    public ResponseEntity<ProjectResponseDto> add(@RequestBody ProjectMemberAddRequestDto request, @RequestParam Long projectId) {
        Project project = projectCommandService.memberAdd(request, projectId);
        return ApiResponse.onSuccess(ProjectConverter.toProjectResponseDto(project));
    }
